...
st.subheader("Current Research Edition")
st.success(
    "The current release integrates the Porto case study and establishes "
    "the scientific framework for the progressive incorporation of modules "
    "in spatial data science, urban accessibility, explainable artificial "
    "intelligence and spatial diagnostics."
)
